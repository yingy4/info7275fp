...
public class PatentContributionByStateReducer extends Reducer<Text,DoubleWritable,Text,DoubleWritable> {
    ...
    private Map<String, String> STATE_MAP = new HashMap<String, String>();;
    ...
    public void reduce(Text key, Iterable<DoubleWritable> values,
        ...
        result.set(sum);
        String ab = key.toString().trim();
        if (STATE_MAP.get(ab) != null) {
            context.write(new Text(STATE_MAP.get(ab)), result);
        }
    }
